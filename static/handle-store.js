...
// يعيد الاسم المحفوظ إن وُجد، وإلا "default" (مساحة عمل مشتركة افتراضية)
// بدون أي نافذة تظهر تلقائياً — الاسم بالكامل اختياري، ويُحدَّد فقط لو
// المستخدم كتبه بنفسه من حقل "اسمك" في شاشة "تهيئة مسارات النظام"
function ensureWorkspaceUsername() {
  return getWorkspaceUsername() || 'default';
}
